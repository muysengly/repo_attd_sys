...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setMaximumSize(QtCore.QSize(120, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_take_photo.sizePolicy().hasHeightForWidth())
        self.pushButton_take_photo.setSizePolicy(sizePolicy)
        self.pushButton_take_photo.setMinimumSize(QtCore.QSize(160, 40))
        self.pushButton_take_photo.setMaximumSize(QtCore.QSize(160, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_take_photo.setFont(font)
        self.pushButton_take_photo.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.pushButton_take_photo.setObjectName("pushButton_take_photo")
        self.horizontalLayout_2.addWidget(self.pushButton_take_photo)
